...
contract ArrayContract {
    ...
    function work_with_arrays(uint256 element, uint8[13] calldata f_array, uint8[] calldata d_array) private pure returns (uint256[] memory) {
        // fn parameters
        f_array[1] = 0;
        d_array[1] = element;
        ...
        // delete
        delete storage_mapping[1];
        delete test_struct.struct_mapping[1];
